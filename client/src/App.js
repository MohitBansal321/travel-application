...
const pinAddSuccess = () => toast.success("Added Pin!!");
...
const pinAddFailure = () => toast.error("Could add pin. Please fill all data!");
          ...
          >
            <div>
              <form onSubmit={handlePinSubmit}>
                ...
                <label>Review</label>
                <textarea
                  placeholder="Say something about this palace..."
